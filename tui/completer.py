...
COMMANDS = {
    ...
    "help": {},
    "status": {},
    "trades": {"slug": None, "run-id": None, "limit": None},
    "trades:backtest": {"slug": None, "run-id": None, "limit": None},
    "trades:paper": {"slug": None, "run-id": None, "limit": None},
    "trades:all": {"slug": None, "run-id": None, "limit": None},
    "runs": {},
    "runs:backtest": {},
    "runs:paper": {},
    "report": {"run-id": None, "limit": None},
    "report:backtest": {"run-id": None, "slug": None, "limit": None},
    "report:paper": {"run-id": None, "slug": None, "limit": None},
    "top": {"slug": None, "limit": None},
    "top:backtest": {"slug": None, "limit": None},
    "top:paper": {"slug": None, "limit": None},
    "top:all": {"slug": None, "limit": None},
    "pnl": {"run-id": None},
    "clear": {},
    "exit": {},
    "agent:backtest": {
    ...
    "alpha:growth": {"ticker": None},
    "alpha:value": {"ticker": None},
    "alpha:compare": {"ticker": None},
    "alpha:runs": {"limit": ["5", "10", "20"]},
    "alpha:show": {"run-id": None},
