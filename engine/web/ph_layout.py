...
_ICONS = {
    ...
    "news-scheduler": '<circle cx="12" cy="12" r="9"/><polyline points="12 7 12 12 16 14"/><path d="M18 4l2-2"/><path d="M4 18l-2 2"/>',
    ...
    "logging": '<path d="M4 4h16v16H4z"/><line x1="8" y1="9" x2="16" y2="9"/><line x1="8" y1="13" x2="16" y2="13"/><line x1="8" y1="17" x2="13" y2="17"/>',
    # Section headers
        ...
        Div(
            ...
            _nav_section(
                ...
                Div(*[_menu_group(lbl, items, active)
                      for lbl, items in AGENT_SHORTCUTS],
                    cls="agent-browser"),
                icon="sec-agents",
                opened=active == "app",
            ),
            ...
            _nav_section(
                ...
                Div(
                    *_MONITORING_EXTRA(active),
                    _page_link("Logging", "/admin/logging", "logging", active),
