...
AGENT_CATALOG_ENTRIES: tuple[AgentCatalogEntry, ...] = (
    ...
    },
    {
        ...
        "category": "research",
        "description": "Read-only normalized premarket snapshots, charts, and evidence commentary.",
        "method": "POST",
        ...
        "safety": "read_only",
        "skills": (
            "Latest and exact-date snapshot retrieval",
            "Sector breadth and ranked movers",
            "Ticker catalyst evidence and risk commentary",
            "Interactive Plotly chart payloads",
        ),
    },
    {
        "slug": "alpha-growth",
